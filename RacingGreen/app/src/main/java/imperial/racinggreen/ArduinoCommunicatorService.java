...
//    private SenderThread mSenderThread;
    ...
    final static String DATA_RECEIVED_INTENT = "racinggreen.intent.action.DATA_RECEIVED";
    final static String SEND_DATA_INTENT = "racinggreen.intent.action.SEND_DATA";
    final static String DATA_SENT_INTERNAL_INTENT = "racinggreen.internal.intent.action.DATA_SENT";
    final static String DATA_EXTRA = "racinggreen.intent.extra.DATA";
            ...
            public void run() {
                ...
                while(mUsbDevice != null ) {
                    ...
                    if (len > 0) {
						...
						//send set number of bytes and read constant number
...
////                    if (DEBUG) Log.i(TAG, "handleMsg()" + msg.what);
//                    if (msg.what == 10) {
